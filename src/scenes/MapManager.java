...
public class MapManager {
    ...
    // 数据与资源
    private int[][] mapData;
    private Image grassImg, stoneImg, flowerImg, mushroomImg;

    public MapManager(GameEngine engine) {
        mapData = new int[GRID_COUNT][GRID_COUNT];
        // 在这里加载资源
        grassImg = engine.loadImage("resource/sprites/Grass1.png");
        stoneImg = engine.loadImage("resource/sprites/Stone.png");
        flowerImg = engine.loadImage("resource/sprites/flowers_bg.png");
        mushroomImg = engine.loadImage("resource/sprites/mushroon_bg.png");
    }
